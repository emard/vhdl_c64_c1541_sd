...
cp rtl_renommes/fpga64_buslogic_roms_mmu.vhd              rtl_dar/fpga64_buslogic_roms_mmu.vhd
cp rtl_renommes/fpga64_sid_iec.vhd                        rtl_dar/fpga64_buslogic_sid_iec.vhd
cp rtl_renommes/fpga64_keyboard_matrix_mark_mcdougall.vhd rtl_dar/fpga64_keyboard_matrix_mark_mcdougall.vhd
cp rtl_renommes/video_vicII_656x_a.vhd                    rtl_dar/video_vicII_656x_a.vhd
