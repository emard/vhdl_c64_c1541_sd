...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25M_50M -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -fclkop 50.00 -fclkop_tol 0.0 -phase_cntl STATIC -fb_mode 1 -fdc /home/guest/src/fpga/c64/vhdl_c64_c1541_sd/proj/lattice/ulx3s/clk4/clk_25M_50M/clk_25M_50M.fdc 

-- Sat Jan 27 22:04:20 2018
...
entity clk_25M_50M is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic);
end clk_25M_50M;

architecture Structure of clk_25M_50M is
